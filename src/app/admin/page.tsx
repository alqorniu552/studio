          ...
          <Card className="shadow-lg">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Input id="auto-attack-proxy-api" placeholder="URL API yang mengembalikan daftar proksi" value={autoAttackProxyApiUrl} onChange={(e) => setAutoAttackProxyApiUrl(e.target.value)} disabled={isAutoAttackEnabled && isAttacking} />
              </div>
              <div className="space-y-2">
